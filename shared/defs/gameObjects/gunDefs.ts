...
export const GunDefs: Record<string, GunDef> = {
    ...
    israel_gun: {
        ...
        bulletType: "bullet_grozas",
        ammo: "40mm",
        projType: "israel_projectile",
        headshotMult: 4,
        speed: { equip: 20, attack: 30 },
        lootImg: {
            sprite: "loot-weapon-israel.img",
            tint: 0xffffff,
            border: "loot-circle-outer-01.img",
            borderTint: 0xffcc00,
            scale: 0.4,
    ...
    transgender_gun: {
        ...
        headshotMult: 2,
        speed: { equip: 20, attack: 0 },
        lootImg: {
            sprite: "loot-transgender.img",
            tint: 0xFFFFFF,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
